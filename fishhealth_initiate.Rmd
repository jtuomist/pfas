...
1. Herring - TEQ in conc turns into NA because of a factor mismatch.
2. Pike is missing from amount although it is an important source of MeHg.
3. All salmonids inherit the concentrations from Baltic salmon.
