...
5. Find why expo_indir is so much higher than EFSA toxicokinetic assessment.
6. Add ERF for PFAS (sum of PFOS, PFHxS, PFOA, PFNA). Solution: Make a new page for ERF of PFAS and add that to adjusted ERFs. First immunology; postpone cholesterol and low birth weight and liver toxicity.
7. Add case burdens for PFAS outcomes. Solution: give rough estimates for immunology to get started.
